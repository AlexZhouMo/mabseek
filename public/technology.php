...
<section class="section section-light">
  <div class="container">
    <div class="pillar reveal">
      ...
      <div class="pillar-media"><img src="assets/images/tech-data.webp" alt="数据训练" onerror="this.remove()"></div>
    </div>
  </div>
</section>
...
<section class="section section-dark">
  <div class="container">
    <div class="pillar pillar--rev reveal">
      ...
      <div class="pillar-media"><img src="assets/images/tech-ai.webp" alt="AI 算法" onerror="this.remove()"></div>
    </div>
  </div>
</section>
...
<section class="section section-light">
  <div class="container">
    <div class="pillar reveal">
      ...
      <div class="pillar-media"><img src="assets/images/tech-wetlab.webp" alt="自动化湿实验" onerror="this.remove()"></div>
    </div>
  </div>
</section>
